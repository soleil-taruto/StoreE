...
namespace Charlotte.Shootings.SHEnemies.Tests
{
	...
	/// テスト用_敵弾
	/// </summary>
	public class SHEnemy_TestTama0001 : SHEnemy
	{
		public SHEnemy_TestTama0001(double x, double y)
			: base(x, y, 0, Kind_e.通常敵)
		{ }

		protected override IEnumerable<bool> E_Draw()
		{
			D2Point speed = DDUtils.AngleToPoint(DDUtils.GetAngle(Shooting.I.Player.X - this.X, Shooting.I.Player.Y - this.Y), 8.0);
			...
			for (; ; )
			{
				...
				DDDraw.DrawCenter(Ground.I.Picture.SHTama0001, this.X, this.Y);
