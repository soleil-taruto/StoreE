...
namespace Charlotte.Shootings.SHEnemies.Tests
{
	...
	/// テスト用_ボス敵
	/// </summary>
	public class SHEnemy_Testボス0003 : SHEnemy
	{
		public SHEnemy_Testボス0003()
		...
		protected override IEnumerable<bool> E_Draw()
		{
			...
			for (; ; )
			{
				...
				DDDraw.DrawCenter(Ground.I.Picture.SHBoss0003, this.X, this.Y);
		...
		private IEnumerable<bool> 攻撃()
		{
			...
			for (; ; )
			{
				...
				Shooting.I.Enemies.Add(new SHEnemy_TestTama0001(this.X - R, this.Y - R));
