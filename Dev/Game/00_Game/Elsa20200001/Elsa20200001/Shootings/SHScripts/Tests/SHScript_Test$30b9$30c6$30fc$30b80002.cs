...
{
	public class SHScript_Testステージ0002 : SHScript
	{
		protected override IEnumerable<bool> E_EachFrame()
		{
			...
			Ground.I.Music.SHStage_02.Play();
			...
			{
				SHEnemy boss = new SHEnemy_Testボス0002();
			...
			Ground.I.SHCanContinueStageNumber = Math.Max(Ground.I.SHCanContinueStageNumber, 3);
			DDSaveData.Save();

			Shooting.I.Script = new SHScript_Testステージ0003(); // 次のステージ
