...
{
	public static class TVWallCatalog
	{
		public static TVWall Create(string name)
		{
			if (name == TopViewConsts.MAPPRM_DEFAULT_VALUE)
				return new TVWall_Dark();
			...
			switch (name)
			{
				...
				case "Dark": wall = new TVWall_Dark(); break;
