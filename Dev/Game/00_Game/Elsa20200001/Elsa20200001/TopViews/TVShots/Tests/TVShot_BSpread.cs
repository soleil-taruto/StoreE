...
namespace Charlotte.TopViews.TVShots.Tests
{
	...
	/// テスト用_自弾
	/// </summary>
	public class TVShot_BSpread : TVShot
	{
		private int Direction; // この自弾の進行方向(8方向_テンキー方式)
		private double R;

		public TVShot_BSpread(double x, double y, int direction, double r)
			: base(x, y, 1, false)
		{
		...
		{
			D2Point speed = TopViewCommon.GetXYSpeed(this.Direction, 10.0);
