...
namespace Charlotte.TopViews.TVTiles
{
	...
	/// タイルのカタログ
	/// </summary>
	public static class TVTileCatalog
	{
		private class TileInfo
		{
			...
			public TileInfo(string name, Func<TVTile> creator)
			{
				{
					int p = name.IndexOf(':');
		...
		{
			new TileInfo(TopViewConsts.TILE_NONE, () => new TVTile_None()),
			new TileInfo("芝", () => new TVTile_Space(Ground.I.Picture2.Tile_A2[0, 0])),
			new TileInfo("水", () => new TVTile_River(Ground.I.Picture2.Tile_A1[0, 0])),
			new TileInfo("箱", () => new TVTile_Wall(Ground.I.Picture2.Tile_B[8, 2])),
			new TileInfo("水辺", () => new TVTile_水辺(Ground.I.Picture2.MiniTile_A1, 16, 0, 3, 60)),
			new TileInfo("森林", () => new TVTile_森林(Ground.I.Picture2.Tile_B, 6, 6, 6, 4, Ground.I.Picture2.Tile_A2[0, 0], Ground.I.Picture.Tile_Dummy)), // 使用しない。-- 木の高さがキャラの身長とほぼ同じなので
			new TileInfo("大森林", () => new TVTile_大森林(Ground.I.Picture2.Tile_B, 6, 6, 6, 4, Ground.I.Picture2.Tile_A2[0, 0], Ground.I.Picture2.Tile_B[4, 6])),
		...
		public static TVTile Create(string name)
		{
