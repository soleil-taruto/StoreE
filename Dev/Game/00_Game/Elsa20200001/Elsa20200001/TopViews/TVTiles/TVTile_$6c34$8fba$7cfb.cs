...
{
	public abstract class TVTile_水辺系 : TVTile
	{
		...
		public TVTile_水辺系(DDPicture[,] pictbl, int pictbl_l, int pictbl_t, int animeKomaNum, int animeKomaCycle)
		{
			_draw = new DrawTask()
			{
				PictureTable = pictbl,
		...
		protected abstract bool IsFriend(TVMapCell cell);
		...
		private class DrawTask : DDTask
		{
			...
			public Predicate<TVMapCell> F_IsFriend;
			...
			{
				bool friend_4 = this.F_IsFriend(TopView.I.Map.GetCell(this.MapTablePoint.X - 1, this.MapTablePoint.Y));
				bool friend_6 = this.F_IsFriend(TopView.I.Map.GetCell(this.MapTablePoint.X + 1, this.MapTablePoint.Y));
				bool friend_8 = this.F_IsFriend(TopView.I.Map.GetCell(this.MapTablePoint.X, this.MapTablePoint.Y - 1));
				bool friend_2 = this.F_IsFriend(TopView.I.Map.GetCell(this.MapTablePoint.X, this.MapTablePoint.Y + 1));

				bool friend_1 = this.F_IsFriend(TopView.I.Map.GetCell(this.MapTablePoint.X - 1, this.MapTablePoint.Y + 1));
				bool friend_3 = this.F_IsFriend(TopView.I.Map.GetCell(this.MapTablePoint.X + 1, this.MapTablePoint.Y + 1));
				bool friend_7 = this.F_IsFriend(TopView.I.Map.GetCell(this.MapTablePoint.X - 1, this.MapTablePoint.Y - 1));
				bool friend_9 = this.F_IsFriend(TopView.I.Map.GetCell(this.MapTablePoint.X + 1, this.MapTablePoint.Y - 1));
				...
				})
				{
					DDDraw.DrawCenter(
						...
						this.DrawPoint.X + info.Dir.X * TopViewConsts.MINI_TILE_W / 2,
						this.DrawPoint.Y + info.Dir.Y * TopViewConsts.MINI_TILE_H / 2
						);
