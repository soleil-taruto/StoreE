...
{
	public class TVEnemy_Bイベント0001 : TVEnemy
	{
		public TVEnemy_Bイベント0001(double x, double y)
			: base(x, y, 0, 0, false)
		{ }
		...
		private void イベント実行()
		{
			...
			using (new Novel())
			{
				...
				if (Novel.I.RequestReturnToTitleMenu)
					TopView.I.RequestReturnToTitleMenu = true;
			}

			TVMusicCollection.Get(TopView.I.Map.MusicName).Play();
