...
namespace Charlotte.TopViews.TVEnemies.Tests
{
	...
	/// テスト用_敵
	/// </summary>
	public class TVEnemy_B1001 : TVEnemy
	{
		public TVEnemy_B1001(double x, double y)
			: base(x, y, 50, 1, false)
		{ }
		...
		protected override IEnumerable<bool> E_Draw()
		{
			...
			TopView.I.Tasks.Add(SCommon.Supplier(this.E_AttackTask()));
			...
			for (; ; )
			{
				foreach (int waitFrm in new int[] { 180, 60, 60 })
				{
					...
					for (int c = 0; c < 4; c++)
					{
						...
						TopView.I.Enemies.Add(new TVEnemy_B1002(this.X, this.Y, speed.X, speed.Y));
					}
				}
			}
		}
