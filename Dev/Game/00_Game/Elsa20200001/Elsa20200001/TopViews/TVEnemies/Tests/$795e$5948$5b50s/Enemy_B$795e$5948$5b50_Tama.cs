...
{
	public class Enemy_B神奈子_Tama : TVEnemy
	{
		...
		public Enemy_B神奈子_Tama(double x, double y)
			: base(x, y, 0, 1, true)
		{
			DDUtils.MakeXYSpeed(this.X, this.Y, TopView.I.Player.X, TopView.I.Player.Y, SPEED, out this.XAdd, out this.YAdd);
		}
		...
		{
			DDGround.EL.Add(SCommon.Supplier(TVEffects.B大爆発(this.X, this.Y)));
		}
	}
}
