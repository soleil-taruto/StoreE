...
namespace Charlotte.TopViews.TVEnemies.Tests
{
	...
	/// テスト用_敵
	/// </summary>
	public class TVEnemy_B0001 : TVEnemy
	{
		public TVEnemy_B0001(double x, double y)
			: base(x, y, 0, 0, false)
		{ }
		...
		protected override IEnumerable<bool> E_Draw()
		{
			for (; ; )
			{
				...
				double rot = DDUtils.GetAngle(TopView.I.Player.X - this.X, TopView.I.Player.Y - this.Y);
				rot += DDUtils.Random.GetReal1() * 0.05;
				D2Point speedAdd = DDUtils.AngleToPoint(rot, 0.1);
				double distance = DDUtils.GetDistance(TopView.I.Player.X - this.X, TopView.I.Player.Y - this.Y);
